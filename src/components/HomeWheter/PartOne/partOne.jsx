...
function PartOne() {
  return (
    <div className="containerPartOne">
      <div className="HourDateOptionsUser">
        <div className="divHour">
          <p className="Hour">10:32</p>
          <p className="AfterMorning">PM</p>
        </div>
      
        <div className="OptionsAndUser">
          <svg
      ...
      <p className="date">17 July, 2020</p>
      <div>
